  ...
  render() {
    ...
    return (
        ...
        >
          ...
          onClick={event => setTimeout( this.handleListItemClick(0), 200)}>
    ...
    <ListItem button component={Link} to="/dashboard/dadossociodemográficos"
          ...
          onClick={event => setTimeout( this.handleListItemClick(1), 200)}>
    ...
    selected={this.state.selectedIndex === 2}
          onClick={event => setTimeout( this.handleListItemClick(2), 200)}>
    ...
    selected={this.state.selectedIndex === 3}
          onClick={event => setTimeout( this.handleListItemClick(3), 200)}>
    ...
    selected={this.state.selectedIndex === 4}
          onClick={event => setTimeout( this.handleListItemClick(4), 200)}>
    ...
    selected={this.state.selectedIndex === 5}
          onClick={event => setTimeout( this.handleListItemClick(5), 200)}>
    ...
    selected={this.state.selectedIndex === 6}
          onClick={event => setTimeout( this.handleListItemClick(6), 200)}>
    ...
    selected={this.state.selectedIndex === 7}
          onClick={event => setTimeout( this.handleListItemClick(7), 200)}>
    ...
    selected={this.state.selectedIndex === 8}
          onClick={event => setTimeout( this.handleListItemClick(8), 200)}>
    ...
    selected={this.state.selectedIndex === 9}
          onClick={event => setTimeout( this.handleListItemClick(9), 200)}>
